...
* added SEB (IBAN) atribute issuing

## v0.2.6

* 229844 - mDL derīguma termiņa maiņa no 7 uz 90 dienām

## v0.2.5

* 229452 - ieviesta pilna Diploma Latviešu valodas versija
* 228551 - ieviestas PID un MDL Latviešu valodas galvenes lokalizācijas
* Dockerfile papildināts ar manuālu `setuptools` instalāciju, savādāk risinājums vairs nebūvējās.

## v0.2.4

* Ieviesti saīsinātie RTU lauku nosaukumi
* ieviesta PID un MDL Latviešu valodas versija.

## v0.2.3

* MDL error hangling
* Added `issuing_authority` to RTU diplomas
