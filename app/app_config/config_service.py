...
class ConfService:
    ...
    # ---------------------------------------------------------------------------
    trusted_CAs_path = "./app/trusted_ca/"
    ...
    rtu_issuing_authority = "RTU"

    # A2Pay doctype
    # a2pay_doctype = "eu.europa.ec.eudi.a2pay.1"
    # a2pay_doctype = "lv.seb.eudi.a2pay.1"
    a2pay_doctype = "eu.europa.ec.eudi.iban"

    # A2Pay namespace
    # a2pay_namespace = "eu.europa.ec.eudi.a2pay.1"
    # a2pay_namespace = "lv.seb.eudi.a2pay.1"
    a2pay_namespace = "eu.europa.ec.eudi.iban"

    # PID validity in days
    seb_validity = 120

    # PID issuing Authority
    seb_issuing_authority = "SEB"

    # PID Organization ID
    seb_organization_id = "EUDI Wallet Reference Implementation"
    ...
    document_mappings = {
        ...
        "eu.europa.ec.eudi.iban": {
            "fields": ["sub"],
            "formatting_functions": {
                "mso_mdoc": {"formatting_function": "iban_mdoc"},
                "vc+sd-jwt": {"formatting_function": "iban_sd_jwt_vc"},
            },
        },
    }
    ...
    common_name={
        ...
        "eu.europa.ec.eudi.rtu_diploma_mdoc": "RTU Diploma",
        "eu.europa.ec.eudi.pseudonym.age_over_18.1": "Age Verification",
        "lv.seb.eudi.a2pay.1": "Account to Pay",
        a2pay_doctype: "Account to Pay",
    }
    ...
    config_doctype = {
        ...
        "eu.europa.ec.eudi.rtu_diploma_mdoc": {
            "issuing_authority": rtu_issuing_authority,
            "organization_id": pid_organization_id,
            "validity": qeaa_validity,
            "organization_name": rtu_issuing_authority,
            "namespace": "eu.europa.ec.eudi.rtu_diploma_mdoc",
        },
        a2pay_doctype: {
            "issuing_authority": seb_issuing_authority,
            "organization_id": seb_organization_id,
            "validity": seb_validity,
            "organization_name": seb_issuing_authority,
            "namespace": a2pay_namespace,
        },
    }
    ...
    dynamic_issuing = {
        ...
        "eu.europa.ec.eudi.iban_mdoc":{
            "eu.europa.ec.eudi.pid.1":{"eu.europa.ec.eudi.pid.1":["family_name","given_name","issuing_authority", "issuing_country"]}
        },
