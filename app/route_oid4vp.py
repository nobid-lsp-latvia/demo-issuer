...
def openid4vp():
    ...
    if "session_id" in session:
        cfgservice.app_logger.debug(", Session ID: " + session["session_id"] + ", " + "Authorization selection, Type: " + "oid4vp")
...
def getpidoid4vp():
    ...
    if "response_code" in request.args and "session_id" in request.args:
        cfgservice.app_logger.debug(", Session ID: " + session["session_id"] + ", " + "oid4vp flow: same_device")
        ...
        cfgservice.app_logger.debug(", Session ID: " + session["session_id"] + ", " + "oid4vp flow: cross_device")
